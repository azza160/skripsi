    ...
    public function run(): void
    {
        ...
        DB::table('hurufs')->insert([
            ...
            [
                ...
                'groups' => 'ka',
                'catatan' => null,
                'audio' => 'https://res.cloudinary.com/dzozxilf6/video/upload/v1747370788/hiragana-ka-audio_iila1g.wav',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'groups' => 'sa',
                'catatan' => null,
                'audio' => 'https://res.cloudinary.com/dzozxilf6/video/upload/v1747370864/hiragana-sa-audio_lcsjo5.wav',
                'created_at' => $now,
                'updated_at' => $now,
            ],
