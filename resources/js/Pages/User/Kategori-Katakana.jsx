...
const categories = [
    {
        ...
        icon: "ゴジュオン",
        description:
            "Huruf dasar Katakana yang terdiri dari 46 karakter, digunakan untuk menuliskan kata serapan dan nama asing.",
        unlocked: true,
        progress: 85,
    ...
    },
    {
        ...
        icon: "ダクテン",
        description:
            "Huruf Katakana dengan tanda ゛yang mengubah bunyi konsonan menjadi bersuara, sering digunakan dalam kata serapan dari bahasa asing.",
        unlocked: true,
        progress: 65,
    ...
    },
    {
        ...
        icon: "ハンダクテン",
        description:
            "Huruf Katakana dengan tanda ゜yang mengubah bunyi konsonan menjadi semi-bersuara, umum digunakan dalam penulisan kata asing.",
        unlocked: true,
        progress: 30,
    ...
    },
    {
        ...
        icon: "ヨウオン",
        description:
            "Gabungan huruf kecil ャ,ュ,ョ dengan konsonan yang menghasilkan bunyi gabungan dalam Katakana, sering muncul pada kata asing.",
        unlocked: true,
        progress: 0,
    ...
    },
    {
        ...
        icon: "ソクオン",
        description:
            "Huruf kecil ツ (ッ) yang menggandakan konsonan berikutnya, penting dalam pelafalan kata serapan di Katakana.",
        unlocked: true,
        progress: 0,
        color: "from-rose-500 to-pink-600",
        bgPattern:
            "radial-gradient(circle, rgba(244, 63, 94, 0.15) 1px, transparent 1px)",
        examples: ["カ + ッ + コ = カッコ", "サ + ッ + カ = サッカ"],
    },
    {
        id: "choon",
        title: "Chōon",
        icon: "チョウオン",
        description:
            "Simbol panjang vokal (ー) dalam Katakana yang digunakan untuk memperpanjang suara vokal, umum dalam kata serapan.",
        unlocked: true,
        progress: 0,
        color: "from-purple-500 to-violet-600",
        bgPattern:
            "radial-gradient(circle, rgba(156, 39, 176, 0.15) 1px, transparent 1px)",
        examples: ["スーパー (suupaa - supermarket)", "コーヒー (koohii - kopi)", "ゲーム (geemu - game)"],
    }
];
...
const tips = [
    {
        ...
        title: "Tahukah kamu?",
        content:
            "Dakuten dalam Katakana juga digunakan untuk mengubah bunyi, seperti カ (ka) menjadi ガ (ga), dan sering muncul dalam kata serapan dari bahasa asing.",
    ...
    },
    {
        ...
        title: "Tips Belajar",
        content:
            "Biasakan membaca kata Katakana dari produk, merek, atau papan iklan. Katakana sering digunakan untuk menulis kata asing di Jepang.",
