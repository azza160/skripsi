...
const vocabularyData = {
  ...
  examples: [
    ...
    {
      id: 2,
      kanji: "彼 は 寿司 を 食べた こと が ありません。",
      furigana: "かれ は すし を たべた こと が ありません。",
      romaji: "Kare wa sushi o tabeta koto ga arimasen.",
      meaning: "He has never eaten sushi.",
      audio: "/audio/example2.mp3",
    },
    {
      id: 3,
      kanji: "昨日 私 は レストラン で 夕食 を 食べました。",
      furigana: "きのう わたし は レストラン で ゆうしょく を たべました。",
      romaji: "Kinō watashi wa resutoran de yūshoku o tabemashita.",
      meaning: "Yesterday I ate dinner at a restaurant.",
      audio: "/audio/example3.mp3",
    },
    {
      id: 4,
      kanji: "子供 は 野菜 を 食べたく ありません。",
      furigana: "こども は やさい を たべたく ありません。",
      romaji: "Kodomo wa yasai o tabetaku arimasen.",
      meaning: "Children don't want to eat vegetables.",
  ...
  conjugations: [
    ...
    },
    {
      ...
      romaji: "tabeta",
      meaning: "ate",
      audio: "/audio/tabeta_plain.mp3",
      examples: [
        {
          kanji: "昨日 ケーキ を 食べた。",
          furigana: "きのう ケーキ を たべた。",
          romaji: "Kinō kēki o tabeta.",
          meaning: "I ate cake yesterday.",
        },
        {
          kanji: "彼 は もう 食べた。",
          furigana: "かれ は もう たべた。",
          romaji: "Kare wa mō tabeta.",
          meaning: "He already ate.",
        },
      ],
    },
    {
      ...
      romaji: "tabemashita",
      meaning: "ate",
      audio: "/audio/tabeta_polite.mp3",
      examples: [
        {
          kanji: "昨日 レストラン で 食べました。",
          furigana: "きのう レストラン で たべました。",
          romaji: "Kinō resutoran de tabemashita.",
          meaning: "I ate at a restaurant yesterday.",
        },
        {
          kanji: "朝 パン を 食べました。",
          furigana: "あさ パン を たべました。",
          romaji: "Asa pan o tabemashita.",
          meaning: "I ate bread in the morning.",
        },
      ],
    },
    {
      ...
      romaji: "tabenai",
      meaning: "don't eat",
      audio: "/audio/tabenai_plain.mp3",
      examples: [
        {
          kanji: "私 は 肉 を 食べない。",
          furigana: "わたし は にく を たべない。",
          romaji: "Watashi wa niku o tabenai.",
          meaning: "I don't eat meat.",
        },
        {
          kanji: "彼 は 朝 食べない。",
          furigana: "かれ は あさ たべない。",
          romaji: "Kare wa asa tabenai.",
          meaning: "He doesn't eat in the morning.",
        },
      ],
    },
  ],
  usagePatterns: [
    {
      ...
      example: {
        kanji: "ケーキ を 食べる",
        furigana: "ケーキ を たべる",
        romaji: "kēki o taberu",
        meaning: "to eat cake",
        audio: "/audio/pattern1.mp3",
      },
    },
    {
      pattern: "〜が食べたい",
      ...
      example: {
        ...
        romaji: "rāmen ga tabetai",
        meaning: "I want to eat ramen",
...
const VocabularyDetailContent = () => {
  ...
  const [hoverState, setHoverState] = useState({ kanji: false, meaning: false })
  ...
  useEffect(() => {
    ...
    return () => {
      if (typeof window !== "undefined" && window.speechSynthesis && audioRef.current) {
  ...
  const playAudio = (text) => {
    if (typeof window !== "undefined" && window.speechSynthesis && audioRef.current) {
      ...
      // Set isPlaying back to false when audio ends
          ...
          >
            ...
            >
              <div className="p-6 bg-gradient-to-r from-primary/20 to-transparent">
                <h3 className="text-xl font-bold">Latihan Menulis</h3>
                <p className="text-sm text-muted-foreground mt-1">Praktikkan menulis kanji dan kana</p>
              </div>
              <div className="p-6">
                <div className="flex flex-col items-center justify-center mb-6">
                  ...
                  <h4 className="text-lg font-medium mb-2">Fitur Segera Hadir!</h4>
                  <p className="text-center text-muted-foreground">
                    Kami sedang mengembangkan fitur latihan menulis untuk membantu Anda mempelajari kanji dan kana
                    dengan lebih efektif.
                  </p>
                </div>
                <div className="flex justify-end">
                  <Button onClick={() => setShowWritingModal(false)} className="rounded-full">
                    Tutup
                  </Button>
                </div>
              </div>
            ...
            >
                ...
                >
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent>{showFurigana ? "Sembunyikan Furigana" : "Tampilkan Furigana"}</TooltipContent>
                    </Tooltip>
                    </TooltipProvider>
                    <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent>{isFavorite ? "Hapus dari Favorit" : "Tambahkan ke Favorit"}</TooltipContent>
                    </Tooltip>
                    </TooltipProvider>
                </motion.div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent>Mode Flashcard</TooltipContent>
                    </Tooltip>
                    </TooltipProvider>
                </div>
                </div>
          ...
          >
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <Link href={route('list-kosakata')}>
                <span className="text-muted-foreground dark:text-slate-400 hover:text-violet-800 dark:hover:text-violet-300 transition-all duration-300">List Kosakata</span>
              </Link>
              <span className="text-primary dark:text-violet-400">/</span>
              <Link href={route('detail-kosakata')}>
                <span className="text-violet-400 dark:text-violet-600 capitalize">Detail - taberu</span>
              </Link>
...
<p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl mx-auto">
  ...
  <span className="relative inline-block mx-1 px-2 bg-primary/10 dark:bg-primary/30 text-primary dark:text-violet-300 rounded-md">たべる</span>,
  yang berarti
  <span className="relative inline-block mx-1 px-2 bg-primary/10 dark:bg-primary/30 text-primary dark:text-violet-300 rounded-md">makan</span>,
  lengkap dengan bentuk lain, cara baca,
  dan penggunaannya dalam kalimat sehari-hari.
  <br />
  <span className="text-sm inline-block mt-2 bg-primary/5 px-3 py-1 rounded-full">
    Kuasai makna dan konteks dari setiap kosakata yang kamu pelajari!
  </span>
</p>
        ...
        {flashcardMode ? (
            ...
            <div className="relative">
                ...
                >
                    {/* Front of card (Kanji) */}
                    <div
                    className={`absolute w-full h-full backface-hidden rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-primary/5 flex flex-col items-center justify-center p-6 shadow-lg shadow-primary/10 ${flashcardFlipped ? "opacity-0" : "opacity-100"}`}
                    style={{ backfaceVisibility: "hidden" }}
                    >
                    <div className="absolute top-4 right-4 flex gap-2">
                        <Badge variant="outline" className="bg-primary/10 border-primary/20 capitalize">
                        {vocabularyData.type}
                        </Badge>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        onClick={(e) => {
                            e.stopPropagation()
                            playAudio(vocabularyData.kanji)
                        }}
                    ...
                    <div className="text-center relative">
                        ...
                        <div className="text-2xl font-medium mb-3">{vocabularyData.romaji}</div>
                        <div className="text-4xl font-bold mb-4 text-primary">{vocabularyData.meaning}</div>
                        ...
                        <div className="flex items-center gap-2 bg-amber-500/10 p-3 rounded-lg">
                            ...
                            <span className="text-sm">{vocabularyData.mnemonics}</span>
                        </div>
                        </div>
            ...
            <motion.div variants={itemVariants}>
                ...
                className={`mb-10 overflow-hidden border-2 border-primary/20 relative shadow-xl shadow-primary/5 ${
                    isFavorite ? "bg-gradient-to-br from-transparent via-amber-50/10 to-transparent" : ""
                }`}
                >
                ...
                <CardHeader className="bg-gradient-to-r from-primary/20 to-transparent relative z-10 pb-6">
                    ...
                    <div>
                        ...
                        <span className="text-primary">{vocabularyData.meaning}</span>
                        </CardTitle>
                        <CardDescription className="mt-2 text-base">Kata kerja reguler grup 2 (-ru)</CardDescription>
                    </div>
                ...
                <CardContent className="pt-6 relative z-10">
                    ...
                    >
                        ...
                        <Button
                            variant="outline"
                            size="sm"
                            onClick={() => playAudio(vocabularyData.kanji)}
                        ...
                        >
                            {isPlaying ? <PauseCircle className="h-4 w-4 mr-1" /> : <Volume2 className="h-4 w-4 mr-1" />}
                            <span>{isPlaying ? "Memutar..." : "Dengarkan"}</span>
                        </Button>
                        </motion.div>
                    </motion.div>
                    ...
                    <div className="flex-1 bg-gradient-to-br from-primary/10 to-transparent rounded-xl p-5 border border-primary/20 shadow-md">
                        ...
                        <div className="flex justify-between items-center">
                            <div className="text-2xl font-medium text-primary/90">{vocabularyData.romaji}</div>
                        </div>
                        <div className="text-xl">{vocabularyData.meaning}</div>

                        <div className="mt-3 pt-3 border-t border-primary/10">
                            <div className="text-sm font-medium mb-1 text-muted-foreground">Catatan:</div>
                            <div className="text-sm bg-primary/10 p-3 rounded-md">{vocabularyData.notes}</div>
                        </div>

                        <div className="mt-3">
                            <div className="text-sm font-medium mb-1 text-muted-foreground">Mnemonic:</div>
                    ...
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <Badge
                            variant="outline"
                            className={`${
                            isFavorite ? "bg-amber-100/50 border-amber-200" : "bg-primary/10 border-primary/20"
                            }`}
                        >
                            {progress}%
                        </Badge>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>Belajar dengan Flashcard</TooltipContent>
                        </Tooltip>
                        </TooltipProvider>
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>Latihan Menulis Kanji</TooltipContent>
                        </Tooltip>
                        </TooltipProvider>
                    </div>
            ...
            <motion.div variants={itemVariants} className="mb-10">
                ...
                <h2 className="text-2xl font-bold">Contoh Kalimat</h2>
                </div>
                ...
                {vocabularyData.examples.map((example, index) => (
                    ...
                    onMouseEnter={() => highlightExample(example.id)}
                    ...
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-lg font-medium mb-3 leading-relaxed tracking-wide">{example.kanji}</div>
                        {showFurigana && (
                            <div className="text-sm text-muted-foreground mb-3 leading-relaxed tracking-wide">
                            {example.furigana}
                            </div>
                        )}
                        <div className="text-base mb-3">{example.romaji}</div>
                        <div className="text-base text-muted-foreground font-medium bg-primary/5 p-2 rounded-md">
                            "{example.meaning}"
                        </div>
                        </div>
                        <motion.div whileHover={{ scale: 1.1, rotate: 10 }} whileTap={{ scale: 0.9 }} className="ml-3">
                        <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => playAudio(example.kanji)}
                    ...
                    <div className="flex justify-end gap-2 mt-3">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>Simpan contoh kalimat ini</TooltipContent>
                        </Tooltip>
                        </TooltipProvider>
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>Ulangi audio</TooltipContent>
                        </Tooltip>
                        </TooltipProvider>
                    </div>
                    </motion.div>
            ...
            <motion.div variants={itemVariants} className="mb-10">
                ...
                <div className="flex items-center gap-3 bg-gradient-to-r from-primary/20 to-transparent p-3 rounded-lg">
                    ...
                    <h2 className="text-2xl font-bold">Bentuk Lainnya</h2>
                </div>
                ...
                >
                    {showEmptyState ? "Tampilkan Data" : "Lihat Tanpa Data"}
                </Button>
                </div>

                <Tabs defaultValue="conjugations" value={activeTab} onValueChange={setActiveTab} className="relative">
                ...
                <TabsList className="grid w-full grid-cols-2 p-1 rounded-xl bg-primary/10 border border-primary/20 shadow-md">
                    <TabsTrigger
                    value="conjugations"
                ...
                <TabsContent value="conjugations" className="mt-6">
                    {showEmptyState || vocabularyData.conjugations.length === 0 ? (
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    >
                        ...
                        <h3 className="text-xl font-medium mb-2">Belum Ada Bentuk Konjugasi</h3>
                        <p className="text-muted-foreground max-w-md mb-4">
                        Kosakata ini belum memiliki bentuk konjugasi. Bentuk konjugasi akan membantu Anda memahami
                        penggunaan kata dalam berbagai konteks.
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {vocabularyData.conjugations.map((conj, index) => (
                        <motion.div
                            key={index}
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            ...
                            <div className="font-medium">{conj.form}</div>
                            ...
                            <div className="flex justify-between items-start mb-3">
                                <div>
                                {showFurigana && (
                                    <div className="text-sm text-muted-foreground mb-1">{conj.furigana}</div>
                                )}
                                <div className="text-base mb-1">{conj.romaji}</div>
                                <div className="text-sm text-muted-foreground">"{conj.meaning}"</div>
                                </div>
                                <motion.div whileHover={{ scale: 1.1, rotate: 10 }} whileTap={{ scale: 0.9 }}>
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    onClick={() => playAudio(conj.kanji)}
                            ...
                            <div className="mt-3 pt-3 border-t border-primary/10">
                                <div className="text-sm font-medium mb-2">Contoh:</div>
                                {conj.examples.map((example, idx) => (
                                <div key={idx} className="mb-3 bg-primary/10 p-3 rounded-lg">
                                    <div className="text-base font-medium mb-1">{example.kanji}</div>
                                    {showFurigana && (
                                    <div className="text-sm text-muted-foreground mb-1">{example.furigana}</div>
                                    )}
                                    <div className="text-sm mb-1">{example.romaji}</div>
                ...
                <TabsContent value="patterns" className="mt-6">
                    {showEmptyState || vocabularyData.usagePatterns.length === 0 ? (
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="p-8 rounded-xl border-2 border-dashed border-primary/20 flex flex-col items-center justify-center text-center"
                    >
                        ...
                        <h3 className="text-xl font-medium mb-2">Belum Ada Pola Penggunaan</h3>
                        <p className="text-muted-foreground max-w-md mb-4">
                        Kosakata ini belum memiliki pola penggunaan. Pola penggunaan akan membantu Anda memahami bagaimana
                        kata ini digunakan dalam kalimat.
                        </p>
                        <Button variant="outline" className="rounded-full">
                        <Plus className="h-4 w-4 mr-2" />
                        Tambahkan Pola
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {vocabularyData.usagePatterns.map((pattern, index) => (
                        <motion.div
                            key={index}
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            ...
                            className="border-2 border-primary/20 rounded-xl overflow-hidden shadow-md"
                        >
                            <div className="bg-gradient-to-r from-primary/20 to-transparent p-3">
                            <div className="font-medium text-lg">{pattern.pattern}</div>
                            {showFurigana && <div className="text-sm text-muted-foreground">{pattern.furigana}</div>}
                            </div>

                            <div className="p-4">
                            <div className="mb-3">
                                <div className="text-base mb-1">{pattern.romaji}</div>
                                <div className="text-sm text-muted-foreground">"{pattern.meaning}"</div>
                            </div>
                            ...
                            <div className="mt-3 pt-3 border-t border-primary/10">
                                ...
                                <div className="flex justify-between items-start">
                                    <div>
                                    <div className="text-base font-medium mb-1">{pattern.example.kanji}</div>
                                    {showFurigana && (
                                        <div className="text-sm text-muted-foreground mb-1">{pattern.example.furigana}</div>
                                    )}
                                    <div className="text-sm mb-1">{pattern.example.romaji}</div>
                                    <div className="text-sm text-muted-foreground">"{pattern.example.meaning}"</div>
                                    </div>
                                    <motion.div whileHover={{ scale: 1.1, rotate: 10 }} whileTap={{ scale: 0.9 }}>
                                    <Button
                                        variant="ghost"
                                        size="icon"
                                        onClick={() => playAudio(pattern.example.kanji)}
            ...
            {/* Related Words Section - Enhanced with better design */}
            <motion.div
            ...
            >
                ...
                <h2 className="text-2xl font-bold">Kata-kata Terkait</h2>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {vocabularyData.relatedWords.map((word, index) => (
                    <motion.div
                    key={index}
                    whileHover={{ scale: 1.03, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
                    className="border-2 border-primary/20 rounded-xl p-5 bg-gradient-to-br from-primary/10 to-transparent shadow-md"
                    >
                    <div className="flex justify-between items-start">
                        <div>
                        <div className="text-xl font-medium mb-1">{word.word}</div>
                        <div className="text-sm text-muted-foreground mb-1 bg-primary/10 px-2 py-1 rounded-md inline-block">
                            {word.reading}
                        </div>
                        <div className="text-sm mb-1 mt-2">{word.romaji}</div>
            ...
            >
                ...
                <h2 className="text-2xl font-bold">Komunitas Belajar</h2>
                </div>
                ...
                <div className="bg-gradient-to-r from-primary/20 to-transparent p-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                        <h3 className="text-lg font-medium">Diskusi Kosakata</h3>
                        <p className="text-sm text-muted-foreground">
                            Bagikan tips dan trik belajar dengan pengguna lain
                        </p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2">
                        ...
                        <span>{vocabularyData.stats.learners} Pelajar</span>
                        </Badge>
                        <Badge variant="outline" className="bg-primary/10 border-primary/20">
                ...
                <div className="p-5">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="text-base font-medium">Statistik Kosakata</h4>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div className="bg-primary/5 p-3 rounded-lg text-center">
                        <div className="text-sm text-muted-foreground mb-1">Dilihat</div>
                        <div className="text-lg font-medium">{vocabularyData.stats.views}</div>
                        </div>
                        <div className="bg-primary/5 p-3 rounded-lg text-center">
                        <div className="text-sm text-muted-foreground mb-1">Pelajar</div>
                        <div className="text-lg font-medium">{vocabularyData.stats.learners}</div>
                        </div>
                        <div className="bg-primary/5 p-3 rounded-lg text-center">
                        <div className="text-sm text-muted-foreground mb-1">Favorit</div>
                        <div className="text-lg font-medium">{vocabularyData.stats.favorites}</div>
                        </div>
                        <div className="bg-primary/5 p-3 rounded-lg text-center">
                        <div className="text-sm text-muted-foreground mb-1">Diperbarui</div>
                        <div className="text-lg font-medium">{vocabularyData.stats.lastUpdated}</div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <h4 className="text-base font-medium">Pertanyaan Populer</h4>
                        </div>
                        <Button variant="ghost" size="sm" className="rounded-full text-xs">
                        Lihat Semua
                        </Button>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-sm text-muted-foreground">Ditanyakan oleh Budi</span>
                        </div>
                        <p className="text-sm font-medium">Apa perbedaan penggunaan 食べる dan 食う?</p>
                        </div>
                        <div className="border border-primary/20 rounded-lg p-3 hover:bg-primary/5 transition-colors cursor-pointer">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-sm text-muted-foreground">Ditanyakan oleh Ani</span>
                        </div>
                        <p className="text-sm font-medium">
                            Bagaimana cara mengingat konjugasi kata kerja ini dengan mudah?
                        </p>
                        </div>
                    </div>
                    </div>
            ...
            <motion.div
                variants={itemVariants}
                className="flex justify-between items-center pt-6 mt-10 border-t border-primary/10 pb-20"
            >
...
export default function VocabularyDetailIndex(){
    return (
        <Dashboard>
            <VocabularyDetailContent></VocabularyDetailContent>
        </Dashboard>
    )
}
